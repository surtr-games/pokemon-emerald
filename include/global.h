...
struct SaveBlock1
{
    ...
    /*0x5F6*/ struct ItemSlot bagPocket_KeyItems[BAG_KEYITEMS_COUNT];
    /*0x66E*/ struct ItemSlot bagPocket_PokeBalls[BAG_POKEBALLS_COUNT];
    /*0x6AE*/ struct ItemSlot bagPocket_TMHM[BAG_TMHM_COUNT];
    /*0x7AE*/ struct ItemSlot bagPocket_Berries[BAG_BERRIES_COUNT];
    /*0x866*/ struct Pokeblock pokeblocks[POKEBLOCKS_COUNT];
    /*0x9A6*/ u8 seen1[NUM_DEX_FLAG_BYTES];
    /*0x9DA*/ u16 berryBlenderRecords[3];
    /*0x9E0*/ u8 unused_9C2[6];
    /*0x9EE*/ u16 trainerRematchStepCounter;
    /*0x9EC*/ u8 trainerRematches[MAX_REMATCH_ENTRIES];
    /*0xA4C*/ //u8 padding3[2];
    /*0xA4E*/ struct ObjectEvent objectEvents[OBJECT_EVENTS_COUNT];
    /*0xC8E*/ struct ObjectEventTemplate objectEventTemplates[OBJECT_EVENT_TEMPLATES_COUNT];
    /*0x128E*/ u8 flags[NUM_FLAG_BYTES];
    /*0x13BA*/ u16 vars[VARS_COUNT];
    /*0x15BA*/ u32 gameStats[NUM_GAME_STATS];
    /*0x16BA*/ struct BerryTree berryTrees[BERRY_TREES_COUNT];
    /*0x1ABA*/ struct SecretBase secretBases[SECRET_BASES_COUNT];
    /*0x273A*/ u8 playerRoomDecorations[DECOR_MAX_PLAYERS_HOUSE];
    /*0x2758*/ u8 playerRoomDecorationPositions[DECOR_MAX_PLAYERS_HOUSE];
    /*0x2764*/ u8 decorationDesks[10];
    /*0x276E*/ u8 decorationChairs[10];
    /*0x2778*/ u8 decorationPlants[10];
    /*0x2782*/ u8 decorationOrnaments[30];
    /*0x27A0*/ u8 decorationMats[30];
    /*0x27BE*/ u8 decorationPosters[10];
    /*0x27C8*/ u8 decorationDolls[40];
    /*0x27E0*/ u8 decorationCushions[10];
    /*0x27EC*/ //u8 padding4[2];
    /*0x27EE*/ TVShow tvShows[TV_SHOWS_COUNT];
    /*0x2B6E*/ PokeNews pokeNews[POKE_NEWS_COUNT];
    /*0x2BAE*/ u16 outbreakPokemonSpecies;
    /*0x2BB0*/ u8 outbreakLocationMapNum;
    /*0x2BB1*/ u8 outbreakLocationMapGroup;
    /*0x2BB2*/ u8 outbreakPokemonLevel;
    /*0x2BB3*/ u8 outbreakUnused1;
    /*0x2BB4*/ u16 outbreakUnused2;
    /*0x2BB6*/ u16 outbreakPokemonMoves[MAX_MON_MOVES];
    /*0x2BBE*/ u8 outbreakUnused3;
    /*0x2BBF*/ u8 outbreakPokemonProbability;
    /*0x2BC0*/ u16 outbreakDaysLeft;
    /*0x2BC2*/ struct GabbyAndTyData gabbyAndTyData;
    /*0x2BCE*/ u16 easyChatProfile[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2BDA*/ u16 easyChatBattleStart[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2BE6*/ u16 easyChatBattleWon[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2BF2*/ u16 easyChatBattleLost[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2BFE*/ struct Mail mail[MAIL_COUNT];
    /*0x2E3E*/ u8 unlockedTrendySayings[NUM_TRENDY_SAYING_BYTES]; // Bitfield for unlockable Easy Chat words in EC_GROUP_TRENDY_SAYING
    /*0x2E43*/ //u8 padding5[3];
    /*0x2E46*/ OldMan oldMan;
    /*0x2E82*/ struct DewfordTrend dewfordTrends[SAVED_TRENDS_COUNT];
    /*0x2EAE*/ struct ContestWinner contestWinners[NUM_CONTEST_WINNERS]; // see CONTEST_WINNER_*
    /*0x304E*/ struct DayCare daycare;
    /*0x316E*/ struct LinkBattleRecords linkBattleRecords;
    /*0x31C6*/ u8 giftRibbons[GIFT_RIBBONS_COUNT];
    /*0x31D1*/ struct ExternalEventData externalEventData;
    /*0x31E5*/ struct ExternalEventFlags externalEventFlags;
    /*0x31FA*/ struct Roamer roamer;
    /*0x3216*/ struct EnigmaBerry enigmaBerry;
    /*0x324A*/ struct MysteryGiftSave mysteryGift;
    /*0x35B6*/ u8 unused_3598[0x162];
