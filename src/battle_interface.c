...
static const u8 sLastUsedBallWindowGfx[] = INCBIN_U8("graphics/battle_interface/last_used_ball_r_cycle.4bpp");
static const u16 sLastUsedBallPalette[] = INCBIN_U16("graphics/battle_interface/last_used_ball.gbapal");
...
static const struct SpritePalette sSpritePalette_LastUsedBall =
{
    sLastUsedBallPalette, LAST_BALL_WINDOW_TAG
};
...
void TryAddLastUsedBallItemSprites(void)
{
    ...
    // window
    LoadSpritePalette(&sSpritePalette_LastUsedBall);
