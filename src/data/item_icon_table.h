const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // Vitamins
    [ITEM_MUTAGEN_HP] = {gItemIcon_Mutagen_HP, gItemIconPalette_Mutagen_HP},
    [ITEM_MUTAGEN_ATK] = {gItemIcon_Mutagen_Atk, gItemIconPalette_Mutagen_Atk},
    [ITEM_MUTAGEN_DEF] = {gItemIcon_Mutagen_Def, gItemIconPalette_Mutagen_Def},
    [ITEM_MUTAGEN_SPEED] = {gItemIcon_Mutagen_Speed, gItemIconPalette_Mutagen_Speed},
    [ITEM_MUTAGEN_SPDEF] = {gItemIcon_Mutagen_SpDef, gItemIconPalette_Mutagen_SpDef},
    [ITEM_MUTAGEN_SPATK] = {gItemIcon_Mutagen_SpAtk, gItemIconPalette_Mutagen_SpAtk},
