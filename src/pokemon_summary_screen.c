...
static void CreateTextForStats(u8 *dst, s8 natureEffect, u32 stat, u32 strId, u32 n);
...
static void BufferIvOrEvStats(u8 mode)
{
    ...
    const s8 *natureEffect = gNatureStatTable[sMonSummaryScreen->summary.nature];
    ...
    case STAT_STATS:
    default:
        CreateTextForStats(currHPString, 0, hp, 0, 3);
        CreateTextForStats(gStringVar1, 0, hp2, 1, 3);
        CreateTextForStats(gStringVar2, natureEffect[STAT_ATK - 1], atk, 2, 7);
        CreateTextForStats(gStringVar3, natureEffect[STAT_DEF - 1], def, 3, 7);
        DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsLeftColumnLayout);
        PrintLeftColumnStats();

        CreateTextForStats(gStringVar1, natureEffect[STAT_SPATK - 1], spA, 0, 3);
        CreateTextForStats(gStringVar2, natureEffect[STAT_SPDEF - 1], spD, 1, 3);
        CreateTextForStats(gStringVar3, natureEffect[STAT_SPEED - 1], spe, 2, 3);
        DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsRightColumnLayout);
        PrintRightColumnStats();
        break;
    case STAT_IVS:
    case STAT_EVS:
        CreateTextForStats(gStringVar1, 0, hp, 0, 7);
        CreateTextForStats(gStringVar2, 0, atk, 1, 7);
        CreateTextForStats(gStringVar3, 0, def, 2, 7);
        DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsLeftColumnLayoutIVEV);
        PrintLeftColumnStats();

        CreateTextForStats(gStringVar1, 0, spA, 0, 3);
        CreateTextForStats(gStringVar2, 0, spD, 1, 3);
        CreateTextForStats(gStringVar3, 0, spe, 2, 3);
        DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsRightColumnLayout);
        PrintRightColumnStats();
        break;
    }
...
static void BufferLeftColumnStats(void)
{
    ...
    DynamicPlaceholderTextUtil_Reset();
    CreateTextForStats(currentHPString, 0, sMonSummaryScreen->summary.currentHP, 0, 3);
    CreateTextForStats(maxHPString, 0, sMonSummaryScreen->summary.maxHP, 1, 3);
    CreateTextForStats(attackString, natureEffect[STAT_ATK - 1], sMonSummaryScreen->summary.atk, 2, 7);
    CreateTextForStats(defenseString, natureEffect[STAT_DEF - 1], sMonSummaryScreen->summary.def, 3, 7);
    DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsLeftColumnLayout);
...
static void BufferRightColumnStats(void)
{
    ...
    DynamicPlaceholderTextUtil_Reset();
    CreateTextForStats(gStringVar1, natureEffect[STAT_SPATK - 1], sMonSummaryScreen->summary.spatk, 0, 3);
    CreateTextForStats(gStringVar2, natureEffect[STAT_SPDEF - 1], sMonSummaryScreen->summary.spdef, 1, 3);
    CreateTextForStats(gStringVar3, natureEffect[STAT_SPEED - 1], sMonSummaryScreen->summary.speed, 2, 3);
    DynamicPlaceholderTextUtil_ExpandPlaceholders(gStringVar4, sStatsRightColumnLayout);
}
